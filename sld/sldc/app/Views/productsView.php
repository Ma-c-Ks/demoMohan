...
<title>Shri Lakshmi|Products</title>
<head>
    <meta charset="utf-8">
                   ...
                   <div class="col-md-4">
                    <article class="blog_item">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?php echo base_url("products/category/$rowCategory->categoryname")?>">
                                    <h2><?php echo $rowCategory->categoryname?></h2>
                                </a>
